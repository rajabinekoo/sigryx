...
// SetRefreshTokenHash sets the "refresh_token_hash" field.
func (u *SessionUpsert) SetRefreshTokenHash(v []byte) *SessionUpsert {
...
// SetRefreshTokenHash sets the "refresh_token_hash" field.
func (u *SessionUpsertOne) SetRefreshTokenHash(v []byte) *SessionUpsertOne {
...
// SetRefreshTokenHash sets the "refresh_token_hash" field.
func (u *SessionUpsertBulk) SetRefreshTokenHash(v []byte) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetRefreshTokenHash(v)
	})
}
