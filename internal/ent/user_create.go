...
func (_c *UserCreate) SetIsRootAdmin(v bool) *UserCreate {
	_c.mutation.SetIsRootAdmin(v)
	return _c
}

// SetNillableIsRootAdmin sets the "is_root_admin" field if the given value is not nil.
func (_c *UserCreate) SetNillableIsRootAdmin(v *bool) *UserCreate {
	if v != nil {
		_c.SetIsRootAdmin(*v)
	}
	return _c
...
func (_c *UserCreate) SetRoleID(v string) *UserCreate {
	_c.mutation.SetRoleID(v)
	return _c
}

// SetNillableRoleID sets the "role_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableRoleID(v *string) *UserCreate {
	if v != nil {
		_c.SetRoleID(*v)
	}
	return _c
...
func (_c *UserCreate) SetAllowedCidrs(v []string) *UserCreate {
...
func (_c *UserCreate) defaults() {
	if _, ok := _c.mutation.IsRootAdmin(); !ok {
		v := user.DefaultIsRootAdmin
		_c.mutation.SetIsRootAdmin(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.IsRootAdmin(); !ok {
		return &ValidationError{Name: "is_root_admin", err: errors.New(`ent: missing required field "User.is_root_admin"`)}
	}
	if _, ok := _c.mutation.Active(); !ok {
		return &ValidationError{Name: "active", err: errors.New(`ent: missing required field "User.active"`)}
	}
	if _, ok := _c.mutation.AllowedCidrs(); !ok {
		return &ValidationError{Name: "allowed_cidrs", err: errors.New(`ent: missing required field "User.allowed_cidrs"`)}
	}
	return nil
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IsRootAdmin(); ok {
		_spec.SetField(user.FieldIsRootAdmin, field.TypeBool, value)
		_node.IsRootAdmin = value
	}
...
// SetAllowedCidrs sets the "allowed_cidrs" field.
func (u *UserUpsert) SetAllowedCidrs(v []string) *UserUpsert {
	u.Set(user.FieldAllowedCidrs, v)
	return u
}

// UpdateAllowedCidrs sets the "allowed_cidrs" field to the value that was provided on create.
func (u *UserUpsert) UpdateAllowedCidrs() *UserUpsert {
	u.SetExcluded(user.FieldAllowedCidrs)
	return u
}
...
func (u *UserUpsertOne) UpdateNewValues() *UserUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		...
		if _, exists := u.create.mutation.IsRootAdmin(); exists {
			s.SetIgnore(user.FieldIsRootAdmin)
		}
	}))
	return u
}
...
// SetAllowedCidrs sets the "allowed_cidrs" field.
func (u *UserUpsertOne) SetAllowedCidrs(v []string) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetAllowedCidrs(v)
	})
}
...
// UpdateAllowedCidrs sets the "allowed_cidrs" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateAllowedCidrs() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
...
func (u *UserUpsertBulk) UpdateNewValues() *UserUpsertBulk {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		for _, b := range u.create.builders {
			...
			if _, exists := b.mutation.IsRootAdmin(); exists {
				s.SetIgnore(user.FieldIsRootAdmin)
			}
		}
	}))
...
// SetAllowedCidrs sets the "allowed_cidrs" field.
func (u *UserUpsertBulk) SetAllowedCidrs(v []string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetAllowedCidrs(v)
	})
}
...
// UpdateAllowedCidrs sets the "allowed_cidrs" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateAllowedCidrs() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAllowedCidrs()
	})
}
