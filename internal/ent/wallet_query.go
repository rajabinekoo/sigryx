...
func (_q *WalletQuery) QueryKeyRoot() *KeyRootQuery {
...
func (_q *WalletQuery) WithKeyRoot(opts ...func(*KeyRootQuery)) *WalletQuery {
	query := (&KeyRootClient{config: _q.config}).Query()
...
func (_q *WalletQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Wallet, error) {
	...
	if query := _q.withKeyRoot; query != nil {
		if err := _q.loadKeyRoot(ctx, query, nodes, nil,
			func(n *Wallet, e *KeyRoot) { n.Edges.KeyRoot = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *WalletQuery) loadKeyRoot(ctx context.Context, query *KeyRootQuery, nodes []*Wallet, init func(*Wallet), assign func(*Wallet, *KeyRoot)) error {
...
func (_q *WalletQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withKeyRoot != nil {
			_spec.Node.AddColumnOnce(wallet.FieldKeyRootID)
		}
	}
