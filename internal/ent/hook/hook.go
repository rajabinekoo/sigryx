...
func (f KeyRootFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.KeyRootMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.KeyRootMutation", m)
}
...
// function as UnsealKeySlot mutator.
type UnsealKeySlotFunc func(context.Context, *ent.UnsealKeySlotMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UnsealKeySlotFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UnsealKeySlotMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UnsealKeySlotMutation", m)
}
...
// The WalletCounterFunc type is an adapter to allow the use of ordinary
// function as WalletCounter mutator.
type WalletCounterFunc func(context.Context, *ent.WalletCounterMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WalletCounterFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WalletCounterMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WalletCounterMutation", m)
}
